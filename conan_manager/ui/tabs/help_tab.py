...
class HelpTab(ctk.CTkFrame):
    ...
    def _build(self) -> None:
        ...
        app_links = self._card(body, 1, "This App's Links")
        app_link_buttons = ctk.CTkFrame(app_links, fg_color="transparent")
        app_link_buttons.grid(row=1, column=0, sticky="w", padx=12, pady=(0, 10))
        self._button(app_link_buttons, "GitHub", lambda: webbrowser.open("https://github.com/davebowlin/CEEModManager"), column=0)
        self._button(app_link_buttons, "Issues", lambda: webbrowser.open("https://github.com/davebowlin/CEEModManager/issues"), column=1)
        self._button(app_link_buttons, "Releases", lambda: webbrowser.open("https://github.com/davebowlin/CEEModManager/releases"), column=2)

        links = self._card(body, 2, "Original Links")
        ...
        updates = self._card(body, 3, "Updates")
        ...
        support = self._card(body, 4, "Support Diagnostics")
